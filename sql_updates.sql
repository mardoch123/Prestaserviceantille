...
-- ================================
-- Password Reset Tokens (Custom Flow - clients/providers)
-- ================================
...
-- Function to create a password reset token (searches clients & providers)
...
-- Function to reset password with token (updates clients/providers initial_password)
...
-- Function to verify a token without consuming it
